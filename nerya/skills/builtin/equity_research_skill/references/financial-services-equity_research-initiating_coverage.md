...
- Source: `financial-services/equity-research/initiating-coverage`
- Upstream path: `plugins/vertical-plugins/equity-research/skills/initiating-coverage/SKILL.md`

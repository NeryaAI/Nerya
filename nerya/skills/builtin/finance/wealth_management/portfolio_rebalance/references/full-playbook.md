...
- Source: `financial-services/wealth-management/portfolio-rebalance`
- Upstream path: `plugins/vertical-plugins/wealth-management/skills/portfolio-rebalance/SKILL.md`

...
- Source: `financial-services/wealth-management/tax-loss-harvesting`
- Upstream path: `plugins/vertical-plugins/wealth-management/skills/tax-loss-harvesting/SKILL.md`

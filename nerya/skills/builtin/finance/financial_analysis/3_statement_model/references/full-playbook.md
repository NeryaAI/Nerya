...
- Source: `financial-services/financial-analysis/3-statement-model`
- Upstream path: `plugins/vertical-plugins/financial-analysis/skills/3-statement-model/SKILL.md`

...
- Source: `financial-services/financial-analysis/ppt-template-creator`
- Upstream path: `plugins/vertical-plugins/financial-analysis/skills/ppt-template-creator/SKILL.md`
